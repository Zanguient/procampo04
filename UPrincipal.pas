...
type
  TFrmPrincipal = class(TForm)
    ...
    dxNavBarRelEstoqueGrao: TdxNavBarItem;
    acRel_Estoque_Produto: TAction;
    dxNavBarRelEstoqueProduto: TdxNavBarItem;
    ...
    procedure VeículosExecute(Sender: TObject);
    ...
    procedure acRel_Estoque_ProdutoExecute(Sender: TObject);
...
begin
  ...
  StbStatus.Panels[1].Text:= 'Usuário Registrado: '+IntToStr(FUsuario.Codigo)+'-'+FUsuario.Login;
...
begin
  ...
  FrmRel_Estoque_Grao.Create(FPropriedade, FUsuario);
  FrmRel_Estoque_Grao.Show;
  Op.CentralizaForm(FrmRel_Estoque_Grao, FrmPrincipal, Ribbon1.Height, StbStatus.Height);

end;

procedure TFrmPrincipal.acRel_Estoque_ProdutoExecute(Sender: TObject);
begin
  Application.CreateForm(TFrmRel_Estoque_Produto, FrmRel_Estoque_Produto);
  FrmRel_Estoque_Produto.Create(FPropriedade, FUsuario);
  FrmRel_Estoque_Produto.Show;
...
begin
  ...
  FrmRel_Lancamento_Financeiro.Create(FPropriedade, FUsuario);
  FrmRel_Lancamento_Financeiro.Show;
  Op.CentralizaForm(FrmRel_Lancamento_Financeiro, FrmPrincipal, Ribbon1.Height, StbStatus.Height);
end;

procedure TFrmPrincipal.acRel_Manutencao_MaquinaExecute(Sender: TObject);
begin
  Application.CreateForm(TFrmRel_Manutencao_Maquina, FrmRel_Manutencao_Maquina);
...
begin
  ShowMessage(FPropriedade.Cidade.Cidade);
end;
...
procedure TFrmPrincipal.VeículosExecute(Sender: TObject);
begin
